...
이 프로그램은 **GNU General Public License v3.0** 으로 배포됩니다.
전문은 [`LICENSE`](LICENSE) 파일에 있습니다.

- 누구나 자유롭게 **쓰고, 고치고, 나눠 줄 수 있습니다.**
- 다만 **고쳐서 남에게 배포할 때는 그 소스도 같은 라이선스로 공개**해야 합니다.
- 보증은 없습니다. 사용에 따른 책임은 사용자에게 있습니다.

교회·선교지에서 자유롭게 쓰시라고 이 라이선스를 골랐습니다.
누군가 개선한다면 그 개선도 다시 모두에게 돌아가도록 하려는 뜻입니다.

> `배포빌드/ngrok.exe` 는 이 프로그램의 일부가 아니라 [ngrok](https://ngrok.com) 사의
> 별도 프로그램입니다. 위 라이선스는 그 파일에 적용되지 않으며,
> 사용·배포는 ngrok의 약관을 따릅니다.
